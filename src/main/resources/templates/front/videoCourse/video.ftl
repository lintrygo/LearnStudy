...
<head>
    ...
    <script type="text/javascript" src="/barrage/js/jquery.colorpicker.js"></script>
    <script type="text/javascript" src="/barrage/js/demand_Barrage.js"></script>
    <script type="text/javascript" src="/barrage/js/send_Barrage.js"></script>
    <script type="text/javascript" src="/barrage/js/ui.js"></script>
    <link href="css/mycss.css" rel="stylesheet">
    <script type="text/javascript" src="/barrage/js/format_date.js"></script>
    <script type="text/javascript" src="/barrage/js/full_screen.js"></script>
...
<div class="content">
    <div id="video_father">
        <div id="video_info" style="background-color: #f6f9fa">
            <div class="videoinfo"><span>视频名称：<span id="video_name_"></span>&nbsp;&nbsp;</span>
            </div>
            <div class="videoinfo"><span>已点赞<span id="video_like_"></span>次</span>
            </div>
        </div>
