...
<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i> <span>精讲课程管理</span> <span class="pull-right-container"> <i
                        class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li>
                        <a target="navTab"  href="/back/course/list">
                            <i class="fa fa-circle-o"></i> <span>类别管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab"  href="/back/stage/list">
                            <i class="fa fa-circle-o"></i> <span>阶段管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab" href="/back/module/list">
                            <i class="fa fa-circle-o"></i> <span>模块管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab" href="/back/catalog/list">
                            <i class="fa fa-circle-o"></i> <span>目录管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab" href="/back/step/list">
                            <i class="fa fa-circle-o"></i> <span>步骤管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab" href="/back/step/list">
                            <i class="fa fa-circle-o"></i> <span>资源管理</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i> <span>视频课程管理</span> <span class="pull-right-container"> <i
                        class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li>
                        <a target="navTab"  href="/back/videoClass/list">
                            <i class="fa fa-circle-o"></i> <span>类别管理</span>
                        </a>
                    </li>
                    <li>
                        <a target="navTab"  href="/back/video/list">
                            <i class="fa fa-circle-o"></i> <span>视频管理</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i> <span>讨论区管理</span> <span class="pull-right-container"> <i
                        class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li>
                        <a target="navTab"  href="/back/post/list">
                            <i class="fa fa-circle-o"></i> <span>版块管理</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i> <span>用户管理</span> <span class="pull-right-container"> <i
                        class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li>
...
<header class="main-header">
    <a href="index2.html" class="logo">
        <span class="logo-mini"><b>在线学习</b></span>
        <span class="logo-lg"><b>在线学习</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="/user/goModifyPwd/${user.userId}" target="modal" modal="lg"  class="btn btn-default btn-flat">密码修改</a>
                            </div>
                            <div class="pull-right">
                                <a href="/admin/logout" class="btn btn-default btn-flat">安全退出</a>
                            </div>
                        </li>
                    </ul>
                </li>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2022 <a href="https://github.com/babylikebird/common-admin"></a>.
...
<link rel="stylesheet" href="/css/bootstrap/fileinput.css">
 ...
 <link rel="stylesheet" href="/css/bootstrap/bootstrapValidator.css" >
